...
@Data
@Schema(description = "Objeto de transferencia de datos reducido que representa una sede.")
public class BranchDTOReduced {
  ...
  public BranchDTOReduced(Branch branch) {
