...
public class UserService implements IUserService {
  ...
  /* Autogenerated code */ 
  public User updateProfile(String email, String newAlias, String newProfilePictureUrl, String newAddress) {
    User user = userRepository.findByEmail(email)
      .orElseThrow(() -> new RuntimeException("User not found"));

    if (newAlias != null) {
      user.setNickname(newAlias);
    }
    if (newProfilePictureUrl != null) {
    /*user.getUserExtended().setProfilePictureUrl(newProfilePictureUrl);
    }
    if (newAddress != null) {
      user.getUserExtended().setAddress(newAddress);
      */
    }
    return userRepository.save(user);
  }
