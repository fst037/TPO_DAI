...
export default function BookMarks({ navigation }) {
  ...
  const [selectedTab, setSelectedTab] = useState(0); // 0: Favoritos, 1: Para después
  ...
  return (
    <View style={styles.container}>
      ...
      {selectedTab === 0 ? renderRecipeList(favoriteRecipes) : renderRecipeList(remindLaterRecipes)}
    </View>
  );
}
