...
export default function EditIngredient() {
  ...
  const { recipeId, ingredientId } = route.params || {};
    ...
    const fetchData = async () => {
      try {
        ...
        setInitialValues({
          ...
          unitId: usedIngredient?.unitId?.toString() || usedIngredient?.unit?.id?.toString() || '',
          ingredientId: usedIngredient?.ingredientId?.toString() || usedIngredient?.ingredient?.id?.toString() || '',
